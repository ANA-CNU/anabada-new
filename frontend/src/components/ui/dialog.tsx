...
function DialogClose({
  ...
  return <SquircleSurface asChild radius="compact"><DialogPrimitive.Close data-slot="dialog-close" {...props} /></SquircleSurface>
}
...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      <DialogOverlay />
      <SquircleSurface asChild radius="panel"><DialogPrimitive.Content
      ...
      >
        {children}
        {showCloseButton && (
          <SquircleSurface asChild radius="compact"><DialogPrimitive.Close
          ...
          </DialogPrimitive.Close></SquircleSurface>
        )}
      </DialogPrimitive.Content></SquircleSurface>
    </DialogPortal>
  )
}
