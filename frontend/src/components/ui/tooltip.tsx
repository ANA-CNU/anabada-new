  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        {...props}
      >
        <SquircleSurface radius="compact" className="bg-primary px-3 py-1.5">{children}</SquircleSurface>
        <TooltipPrimitive.Arrow className="bg-primary fill-primary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" /> {/* squircle-exception: rotated tooltip arrow geometry */}
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
