    ...
    >
      ...
      >
        <SquircleSurface
          ...
          radius="panel"
          corners={variant === "floating" ? "all" : "none"}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <SquircleSurface asChild radius="panel"><main
...
function SidebarGroupLabel({
  ...
  return (
    <SquircleSurface asChild radius="compact"><Comp
...
function SidebarGroupAction({
  ...
  return (
    <SidebarAction asChild={asChild}
      data-slot="sidebar-group-action"
      data-sidebar="group-action"
      className={cn(
        "text-sidebar-foreground hover:text-sidebar-accent-foreground absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center p-0 outline-hidden transition-transform [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuAction({
  ...
  return (
    <SidebarAction asChild={asChild}
      ...
      className={cn(
        "text-sidebar-foreground hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center p-0 outline-hidden transition-transform [&>svg]:size-4 [&>svg]:shrink-0",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 md:after:hidden",
