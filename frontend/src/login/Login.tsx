      ...
      <Card className="w-full max-w-md bg-white/10 backdrop-blur-md border-white/20">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <SquircleSurface asChild radius="compact"><div className="text-red-400 text-sm bg-red-400/10 border border-red-400/20 p-3 break-keep [overflow-wrap:anywhere]">
                {error}
              </div></SquircleSurface>
            )}
